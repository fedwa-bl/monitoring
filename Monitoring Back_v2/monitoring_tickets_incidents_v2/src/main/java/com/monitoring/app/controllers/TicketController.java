...
public class TicketController {
	...
	public ResponseEntity<?> getStatusCountsByApplication(@RequestParam(name = "appName", required = false) String appName, Principal currentUser) throws JsonProcessingException {
	    ...
	    List<Object[]> results = ticketRepo.countTicketsByStatusForDeveloperAndAppName(currentDeveloperId, appName);
	    Map<Ticket.Status, Long> ticketCountsByStatus = new HashMap<>();
	...
	@GetMapping("/criticite/application/developer")
	public ResponseEntity<?> getCriticiteCountsByApplication(
	    ...
	    List<Object[]> results = ticketRepo.countTicketsByCriticiteForDeveloperAndAppName(currentDeveloperId, appName);
