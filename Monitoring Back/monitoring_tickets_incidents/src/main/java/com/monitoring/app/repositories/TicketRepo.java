...
public interface TicketRepo extends JpaRepository<Ticket, Long>{
	...
	@Query("SELECT COUNT(*) FROM Ticket t WHERE t.developpeur.username = :username AND t.status = 'RÉSOLU' AND MONTH(t.date_creation) = MONTH(NOW())")
	int countByDev(@Param("username") String username);
